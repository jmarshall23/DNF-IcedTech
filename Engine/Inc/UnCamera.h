...
enum EMouseButtons	
{
	MOUSE_Left			= BIT(1),		// Left mouse button.
	MOUSE_Right			= BIT(2),		// Right mouse button.
	MOUSE_Middle 		= BIT(3),		// Middle mouse button.
	MOUSE_FirstHit		= BIT(4),		// Sent when a mouse button is initially hit.
	MOUSE_LastRelease	= BIT(5),		// Sent when last mouse button is released.
	MOUSE_SetMode		= BIT(6),		// Called when a new viewport mode is first set.
	MOUSE_ExitMode		= BIT(7),		// Called when the existing mode is changed.
	MOUSE_Ctrl			= BIT(8),		// Ctrl is pressed.
	MOUSE_Shift			= BIT(9),		// Shift is pressed.
	MOUSE_Alt			= BIT(10),		// Alt is pressed.
	MOUSE_LeftDouble	= BIT(10),		// Left double click.
// jmarshall
	MOUSE_R				= BIT(11),		// R is clicked
	MOUSE_T				= BIT(12),
	MOUSE_S				= BIT(13),
// jmarshall end
};
