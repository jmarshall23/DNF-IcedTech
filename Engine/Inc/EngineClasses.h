...
AUTOGENERATE_NAME(PlayOwnedSound)
...
struct AActor_eventPlayOwnedSound_Parms
{
    class USound* Sound;
    BYTE Slot;
    FLOAT Volume;
...
public:
    ...
    inline void __fastcall eventPlayOwnedSound(class USound* Sound, BYTE Slot, FLOAT Volume, BITFIELD bNoOverride, FLOAT Radius, FLOAT Pitch, BITFIELD bMonitorSound, BITFIELD bClientOnly)
    {
        AActor_eventPlayOwnedSound_Parms Parms;
        Parms.Sound=Sound;
        Parms.Slot=Slot;
        Parms.Volume=Volume;
        Parms.bNoOverride=bNoOverride;
        ...
        ProcessEvent(FindFunctionChecked(ENGINE_PlayOwnedSound),&Parms);
    }
    inline void __fastcall eventPlaySound(class USound* Sound, BYTE Slot, FLOAT Volume, BITFIELD bNoOverride, FLOAT Radius, FLOAT Pitch, BITFIELD bMonitorSound)
    {
...
public:
    ...
    inline void __fastcall eventGiveWeaponTo(class APawn* InventoryPawn, class UClass* WeapClass, BITFIELD bDontSwitch)
    {
        AGameInfo_eventGiveWeaponTo_Parms Parms;
        Parms.InventoryPawn=InventoryPawn;
        Parms.WeapClass=WeapClass;
        Parms.bDontSwitch=bDontSwitch;
        ProcessEvent(FindFunctionChecked(ENGINE_GiveWeaponTo),&Parms);
    }
    inline void __fastcall eventAddDefaultInventory(class APawn* P)
    {
        AGameInfo_eventAddDefaultInventory_Parms Parms;
        Parms.P=P;
...
class ENGINE_API ADukeVoice : public AInfo
{
public:
    DECLARE_FUNCTION(execDukeSay);
    DECLARE_CLASS(ADukeVoice,AInfo,0)
    NO_DEFAULT_CONSTRUCTOR(ADukeVoice)
};
...
AUTOGENERATE_FUNCTION(ADukeVoice,-1,execDukeSay);
